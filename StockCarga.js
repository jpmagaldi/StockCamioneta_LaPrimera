...
import { AppState, FlatList, View, StyleSheet, StatusBar, Text as RNText } from 'react-native';
...
export default function StockCarga({ navigation, route }) {
                ...
                <View style={styles.container}>
                    <View style={styles.header}>
                        ...
                        <SegmentedButtons
                            ...
                            theme={{ colors: { secondaryContainer: '#FCE4E4' } }}
                            buttons={[
